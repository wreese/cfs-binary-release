...
type InodeEntry struct {
	...
	FsId      uint64            `protobuf:"varint,13,opt,name=fsId" json:"fsId,omitempty"`
}
...
type Tombstone struct {
	...
	FsId   uint64 `protobuf:"varint,3,opt,name=fsId" json:"fsId,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
